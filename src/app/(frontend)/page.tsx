...
import Logo from '@/assets/logo-ssm.svg'
    ...
    <>
      <div className="flex flex-col mx-auto w-full max-w-4xl px-4">
        ...
        <footer className="py-8 border-t border-gray-700">
          <div className="container mx-auto px-4 text-center">
            <p className="text-gray-500">&copy; 2025 Source de Sérénité. All rights reserved.</p>
          </div>
        </footer>
      </div>
      {/*<div className="home">
      <div className="content">
        <h1 className="text-gray-500 dark:text-gray-400 mt-2 text-sm">Hello world!</h1>
